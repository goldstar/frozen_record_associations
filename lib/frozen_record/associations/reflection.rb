...
module FrozenRecord::Associations::Reflection
  ...
  module ClassMethods
    ...
    def belongs_to_frozen(name, **options)
      reflection = FrozenRecord::Associations::Reflection.create(:belongs_to, name, nil, options, self)
      FrozenRecord::Associations::Reflection.add_reflection(self, name, reflection)
      FrozenRecord::Associations::Reflection.define_accessors(self, name, reflection)
    end

    def belongs_to_many_frozen(name, **options)
      reflection = FrozenRecord::Associations::Reflection.create(:belongs_to_many, name, nil, options, self)
      FrozenRecord::Associations::Reflection.add_reflection(self, name, reflection)
      FrozenRecord::Associations::Reflection.define_accessors(self, name, reflection)
    end
  end
